...
public class FullFeatureNucleotideDinucleotideNoFlank implements DynamicProgramming {
	...
	public FullFeatureNucleotideDinucleotideNoFlank(int l, int k, 
			boolean isNSBinding,String lFlank, String rFlank, Round0Model R0Model) {
		this.l 			= l;
		this.k 			= k;
